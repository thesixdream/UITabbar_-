...
- (void)layoutSubviews {
	...
	if (imageSize.width != 0 && imageSize.height != 0) {
		CGFloat imageViewCenterY = CGRectGetHeight(self.frame) - titleSize.height - imageSize.height / 2 - 5 -2;
		...
		imageViewCenter.y = (CGRectGetHeight(self.frame) - titleSize.height) / 2 + 3 - 2;
		self.imageView.center = imageViewCenter;
	}
	
	CGPoint labelCenter = CGPointMake(CGRectGetWidth(self.frame) / 2, CGRectGetHeight(self.frame) - 5 - titleSize.height / 2);
